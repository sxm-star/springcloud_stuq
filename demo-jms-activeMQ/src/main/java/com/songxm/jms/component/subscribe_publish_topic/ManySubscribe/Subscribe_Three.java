...
import com.songxm.jms.component.subscribe_publish_topic.listener.JMSListener_Three;
...
public class Subscribe_Three {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            destination = session.createTopic("First-Queue"); //订阅者三 订阅topic
            messageConsumer = session.createConsumer(destination); //创建消息生产者

            messageConsumer.setMessageListener(new JMSListener_Three()); //注册监听
